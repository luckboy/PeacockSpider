...
namespace peacockspider
{
  const char *evaluation_parameter_names[MAX_EVALUATION_PARAMETER_COUNT] = {
    ...
    "EVALUATION_PARAMETER_PAWN_BIG_ZONE",
    "EVALUATION_PARAMETER_KNIGHT_BIG_ZONE",
    "EVALUATION_PARAMETER_BISHOP_BIG_ZONE",
    "EVALUATION_PARAMETER_ROOK_BIG_ZONE",
    "EVALUATION_PARAMETER_QUEEN_BIG_ZONE"
  };
  
  namespace 
  {
    const size_t OLD_MAX_EVALUATION_PARAMETER_COUNT1 = 42;
    
    const char *old_evaluation_parameter_names1[OLD_MAX_EVALUATION_PARAMETER_COUNT1] = {
      "EVALUATION_PARAMETER_KNIGHT_MATERIAL",
      "EVALUATION_PARAMETER_BISHOP_MATERIAL",
      "EVALUATION_PARAMETER_ROOK_MATERIAL",
      "EVALUATION_PARAMETER_QUEEN_MATERIAL",
    ...
    const size_t OLD_MAX_EVALUATION_PARAMETER_COUNT2 = 28;

    const char *old_evaluation_parameter_names2[OLD_MAX_EVALUATION_PARAMETER_COUNT2] = {
      "EVALUATION_PARAMETER_KNIGHT_MATERIAL",
      "EVALUATION_PARAMETER_BISHOP_MATERIAL",
      "EVALUATION_PARAMETER_ROOK_MATERIAL",
      "EVALUATION_PARAMETER_QUEEN_MATERIAL",
    ...
    const size_t OLD_MAX_EVALUATION_PARAMETER_COUNT3 = 17;

    const char *old_evaluation_parameter_names3[MAX_EVALUATION_PARAMETER_COUNT] = {
      "EVALUATION_PARAMETER_KNIGHT_MATERIAL",
      "EVALUATION_PARAMETER_BISHOP_MATERIAL",
      "EVALUATION_PARAMETER_ROOK_MATERIAL",
      "EVALUATION_PARAMETER_QUEEN_MATERIAL",
  ...
  EvaluationParameterFormat old_evaluation_parameter_formats[MAX_OLD_EVALUATION_PARAMETER_FORMAT_COUNT] = {
    EvaluationParameterFormat(OLD_MAX_EVALUATION_PARAMETER_COUNT1, old_evaluation_parameter_names1),
    EvaluationParameterFormat(OLD_MAX_EVALUATION_PARAMETER_COUNT2, old_evaluation_parameter_names2),
    EvaluationParameterFormat(OLD_MAX_EVALUATION_PARAMETER_COUNT3, old_evaluation_parameter_names3)
  };
