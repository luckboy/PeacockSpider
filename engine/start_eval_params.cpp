...
{
  int start_evaluation_parameters[MAX_EVALUATION_PARAMETER_COUNT] = {
    ...
    -2,   // EVALUATION_PARAMETER_PAWN_BIG_ZONE
    -10,  // EVALUATION_PARAMETER_KNIGHT_BIG_ZONE
    -10,  // EVALUATION_PARAMETER_BISHOP_BIG_ZONE
    -15,  // EVALUATION_PARAMETER_ROOK_BIG_ZONE
    -20   // EVALUATION_PARAMETER_QUEEN_BIG_ZONE
  };
}
