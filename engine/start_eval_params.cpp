...
namespace peacockspider
{
  int start_evaluation_parameters[MAX_EVALUATION_PARAMETER_COUNT] = {
    ...
    -20,  // EVALUATION_PARAMETER_QUEEN_KING_PIN
    -20,  // EVALUATION_PARAMETER_ROOK_KING_PIN
    -20,  // EVALUATION_PARAMETER_BISHOP_KING_PIN
    -20,  // EVALUATION_PARAMETER_KNIGHT_KING_PIN
    -20,  // EVALUATION_PARAMETER_PAWN_KING_PIN
    -10,  // EVALUATION_PARAMETER_ROOK_QUEEN_PIN
    -10,  // EVALUATION_PARAMETER_BISHOP_QUEEN_PIN
    -10,  // EVALUATION_PARAMETER_KNIGHT_QUEEN_PIN
    -10,  // EVALUATION_PARAMETER_PAWN_QUEEN_PIN
    -5,   // EVALUATION_PARAMETER_BISHOP_ROOK_PIN
    -5,   // EVALUATION_PARAMETER_KNIGHT_ROOK_PIN
    -5,   // EVALUATION_PARAMETER_PAWN_ROOK_PIN
    -2,   // EVALUATION_PARAMETER_PAWN_BISHOP_PIN
    -2    // EVALUATION_PARAMETER_PAWN_KNIGHT_PIN
  };
}
