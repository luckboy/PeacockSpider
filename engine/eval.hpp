...
namespace peacockspider
{
  ...
  const std::size_t EVALUATION_PARAMETER_PAWN_BIG_ZONE =      17;
  const std::size_t EVALUATION_PARAMETER_KNIGHT_BIG_ZONE =    18;
  const std::size_t EVALUATION_PARAMETER_BISHOP_BIG_ZONE =    19;
  const std::size_t EVALUATION_PARAMETER_ROOK_BIG_ZONE =      20;
  const std::size_t EVALUATION_PARAMETER_QUEEN_BIG_ZONE =     21;
  const std::size_t MAX_EVALUATION_PARAMETER_COUNT =          22;
