...
namespace peacockspider
{
  namespace test
  {
    class BoardTests : public CppUnit::TestFixture
    {
      ...
      CPPUNIT_TEST(test_board_has_attack_method_returns_false_for_no_barries);
      ...
      CPPUNIT_TEST(test_board_generate_pseudolegal_moves_method_does_not_generate_for_white_side_and_pawns_and_barriers);
    ...
    public:
      ...
      void test_board_has_attack_method_returns_false_for_no_barries();
      ...
      void test_board_generate_pseudolegal_moves_method_does_not_generate_for_white_side_and_pawns_and_barriers();
