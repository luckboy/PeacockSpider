...
namespace peacockspider
{
  namespace genalg
  {
    ...
    function<void (const TournamentResult &)> FitnessFunction::fitness_output_function() const
    { return _M_fitness_output_function; }

    void FitnessFunction::set_fitness_output_function(function<void (const TournamentResult &)> fun)
    ...
    bool FitnessFunction::update(int iter, const vector<shared_ptr<int []>> &gene_arrays)
    {
      ...
      _M_fitness_output_function(_M_tournament->result());
      return true;
    }
