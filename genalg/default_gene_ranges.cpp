...
namespace peacockspider
{
  namespace genalg
  {
    Range default_gene_ranges[MAX_EVALUATION_PARAMETER_COUNT] = {
      ...
      Range(0, 10),       // EVALUATION_PARAMETER_PAWN_DEFENCE
      Range(0, 10),       // EVALUATION_PARAMETER_KNIGHT_DEFENCE
      Range(0, 10),       // EVALUATION_PARAMETER_BISHOP_DEFENCE
      Range(0, 10),       // EVALUATION_PARAMETER_ROOK_DEFENCE
      Range(0, 10)        // EVALUATION_PARAMETER_QUEEN_DEFENCE
    };
  }
}
