...
namespace peacockspider
{
  namespace genalg
  {
    Range default_gene_ranges[MAX_EVALUATION_PARAMETER_COUNT] = {
      ...
      Range(-10, 0),      // EVALUATION_PARAMETER_BISHOP_KING_TROPISM
      Range(-10, 0),      // EVALUATION_PARAMETER_ROOK_KING_TROPISM
      Range(-20, 0)       // EVALUATION_PARAMETER_QUEEN_KING_TROPISM
    };
  }
}
