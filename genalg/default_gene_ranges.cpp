...
namespace peacockspider
{
  namespace genalg
  {
    Range default_gene_ranges[MAX_EVALUATION_PARAMETER_COUNT] = {
      ...
      Range(0, 2),        // EVALUATION_PARAMETER_ROOK_CENTER
      Range(0, 20),       // EVALUATION_PARAMETER_ROOK_CASTLING
      Range(0, 2),        // EVALUATION_PARAMETER_QUEEN_CENTER
      ...
      Range(-10, 0),      // EVALUATION_PARAMETER_PAWN_BIG_ZONE
      Range(-20, 0),      // EVALUATION_PARAMETER_KNIGHT_BIG_ZONE
      Range(-20, 0),      // EVALUATION_PARAMETER_BISHOP_BIG_ZONE
      Range(-30, 0),      // EVALUATION_PARAMETER_ROOK_BIG_ZONE
      Range(-40, 0)       // EVALUATION_PARAMETER_QUEEN_BIG_ZONE
    };
  }
}
