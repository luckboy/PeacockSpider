...
namespace peacockspider
{
  namespace genalg
  {
    ...
    function<bool (int, const TournamentResult &)> Selector::fitness_output_function() const
    { return _M_fitness_function->fitness_output_function(); }

    void Selector::set_fitness_output_function(function<bool (int, const TournamentResult &)> fun)
